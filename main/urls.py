...
from .views import other_page, index, BBLoginView, profile, BBLogoutView, \
    ChangeUserInfoView, BBPasswordChangeView, BBPasswordResetView, \
    BBPasswordResetConfirmView, RegisterDoneView, RegisterUserView, \
    user_activate, DeleteUserView, by_rubric, detail, profile_bb_detail, \
