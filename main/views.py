...
from .forms import ChangeUserInfoForm, SearchForm, BbForm, AIFormSet, \
    RegisterUserForm, UserCommentForm, GuestCommentForm
...
class BBPasswordResetView(SuccessMessageMixin, PasswordResetView):
    ...
    success_message = 'На указанную Вами почту направлена ссылка для сброса пароля'
    success_url = reverse_lazy('main:index')


class BBPasswordResetConfirmView(SuccessMessageMixin,
                                 PasswordResetConfirmView):
    template_name = 'main/password_reset_confirm.html'
    success_message = 'Новый пароль успешно создан. Авторизируйтесь.'
