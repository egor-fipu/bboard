...
class Rubric(models.Model):
    ...
    super_rubric = models.ForeignKey('SuperRubric', on_delete=models.PROTECT,
                                     ...
                                     verbose_name='Нардрубрика')


class SuperRubricManager(models.Manager):
    """Диспетчер записей, который выберет только надрубрики"""
...
class SuperRubric(Rubric):
    """Моделб надрубрик (прокси-модель)"""
...
class SubRubricManager(models.Manager):
    """Диспетчер записей, который выберет только подрубрики"""
...
class SubRubric(Rubric):
    ...
    class Meta:
        proxy = True
        ordering = (
            'super_rubric__order', 'super_rubric__name', 'order', 'name')
